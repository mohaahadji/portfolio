...
import { FaReact, FaNode, FaJs, FaCss3Alt, FaHtml5, FaStripe, FaDatabase } from 'react-icons/fa';
...
export default function Home() {
  ...
  return (
    <div className="bg-gray-100 dark:bg-neutral-900 text-gray-800 dark:text-neutral-200 min-h-screen p-8 font-sans transition-colors duration-300">
      
      {/* Dark Mode Toggle Button */}
      <div className="flex justify-end mb-4">
        <button
          onClick={() => setDarkMode(!darkMode)}
          className="p-2 rounded-full bg-gray-200 dark:bg-neutral-700 text-gray-800 dark:text-neutral-200"
        >
      ...
      <p className="text-sm flex items-center space-x-4">
        ...
        <div className="text-4xl font-bold text-gray-600 dark:text-gray-300 mt-4">
          ...
          />
                ...
                <div className="w-5/6 md:w-4/5 lg:w-3/5 m-4 mx-auto text-center">
                <p className="text-sm">
...
<div className="flex justify-center space-x-4 mt-6">
      ...
      <section className="mb-16">
        ...
        <div className="flex items-center justify-center m-4 bg-gray-100 dark:bg-neutral-900">
      <div className="flex bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200 border border-gray-300 dark:border-gray-700 w-5/6 max-w-4xl h-5/6 shadow-lg rounded-md overflow-hidden">
        ...
        <div className="flex-1 p-4 overflow-y-auto">
          <pre className="font-mono text-sm leading-relaxed">
            ...
            <span className="text-gray-500 dark:text-gray-400">19</span> <span className="text-gray-700 dark:text-gray-300">Coding isn’t just about writing lines of code for me—it’s about solving real</span>{"\n"}
            ...
            <span className="text-gray-500 dark:text-gray-400">22</span> <span className="text-gray-700 dark:text-gray-300">technology that feels seamless, intuitive, and impactful. I’m excited to keep</span>{"\n"}
    ...
    <motion.h2
          initial="hidden"
          animate="visible"
          className="text-3xl items-center font-semibold text-center mb-8"
        >Portfolio
      <div className="w-5/6 md:w-4/5 lg:w-4/5 mx-auto text-center">
  <p className="text-sm">
    Here are some of the recent projects I’ve developed, each reflecting my commitment to creating impactful and innovative solutions. From e-commerce platforms to automation tools, these projects demonstrate my dedication to seamless user experiences, efficient functionality, and modern design. Each one has been a unique opportunity to blend creativity and technical skill, helping users achieve their goals in new and engaging ways.
        ...
        >
          ...
          <motion.div
            ...
            >
              ...
              {/* Iframe Section (Full Width) */}
              <div className="w-full h-[600px] border-t dark:border-gray-700 mb-20">
                <img
                  src='quran-mp3.png'
                  title='Elquran App'
                  width="100%"
      ...
      {/* Footer */}
      <footer className="bg-neutral-800 py-6 text-center text-white">
